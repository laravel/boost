...
- Call `Http::preventingStrayRequests()` in test suite to prevent stray HTTP requests from slowing down tests. This applies only to Laravel's HTTP client—review other request mechanisms (e.g., direct Guzzle use)
