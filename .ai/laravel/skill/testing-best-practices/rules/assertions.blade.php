...
2. Fetch {{ $pest ? '`https://pestphp.com/docs/expectations.md` for the expectations of Pest' : '`'.$assist->phpunitDocsUrl('assertions.html').'` for the assertions of PHPUnit' }} for a plain value, a type, a format, or a shape.
